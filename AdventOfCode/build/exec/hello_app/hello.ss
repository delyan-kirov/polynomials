...
;; @generated by Idris 0.6.0-ea093ffae, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Integer 2) "\xa;") ext-0))) (PreludeC-45IO-prim__putStr "Hello world\xa;" ext-0))))
